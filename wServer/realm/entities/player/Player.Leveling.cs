    ...
    public partial class Player
    {
        private static readonly Dictionary<string, Tuple<int, int, int>> questDat =
            new Dictionary<string, Tuple<int, int, int>> //Priority, Min, Max
            {
                ...
                {"Astor", Tuple.Create(16, 15, 1000)},
                {"Ozone", Tuple.Create(16, 15, 1000)},
                {"Urgle God", Tuple.Create(16, 15, 1000)},
                {"Swamp Witch", Tuple.Create(16, 15, 1000)},
                {"White King", Tuple.Create(16, 15, 1000)},
                {"Black King", Tuple.Create(16, 15, 1000)},
                {"Dr Terrible", Tuple.Create(16, 15, 1000)},
